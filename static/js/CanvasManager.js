...
Site.CanvasManager = function() {
    ...
    this.updateQuakeInfo = function(quake) {
        var products = [
            {name:'学加家',version:'1.0.1',customerNum:'2000 所幼儿园接入'},
            {name:'知了',version:'4.0.9',customerNum:'5610 所幼儿园接入'},
            {name:'校易收',version:'3.0.2',customerNum:'10032 所幼儿园接入'},
            {name:'极速校园',version:'1.8.1',customerNum:'3009 所幼儿园接入'},
            {name:'校易宝',version:'2.1.1',customerNum:'2045 所幼儿园接入'},
            {name:'流量宝',version:'1.0.2',customerNum:'1020 所幼儿园接入'},
            ]
        var product = products[Math.floor(Math.random() * 6)]
        self.quakeInfoSpan.innerHTML = "<strong>" + product.name +
